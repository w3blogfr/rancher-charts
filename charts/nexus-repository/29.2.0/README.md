...
This a fork from https://github.com/sonatype/helm3-charts adapted to Rancher Chart.
...
| `nexus.docker.registries[0].tls`            | TLS boolean for the docker registry | false                                   |
